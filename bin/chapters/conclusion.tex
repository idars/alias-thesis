...
% As this project has not led to any immediate effect for hospitalized children and youth, . If only the design process were to be considered while ignoring current inpatient situations, this would be considered achieved as well.
